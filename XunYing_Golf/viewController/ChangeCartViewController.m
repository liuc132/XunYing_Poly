...
//            NSDictionary *recDic = [NSJSONSerialization JSONObjectWithData:nsData options:NSJSONReadingMutableLeaves error:nil];
            ...
            if ([recDic[@"Code"] intValue] > 0) {
                ...
                //
                NSMutableArray *changeCaddyBackInfo = [[NSMutableArray alloc] initWithObjects:allMsg[@"evecod"],@"1",allMsg[@"evesta"],allMsg[@"subtim"],allMsg[@"everes"][@"result"],allMsg[@"everes"][@"everea"],allMsg[@"hantim"],@"",@"",@"",@"",@"",@"",@"",@"",weakSelf.curGrpCarts.Rows[weakSelf.selectedCartIndex][@"carcod"],weakSelf.curGrpCarts.Rows[weakSelf.selectedCartIndex][@"carnum"],weakSelf.curGrpCarts.Rows[weakSelf.selectedCartIndex][@"carsea"],@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"",@"", nil];
